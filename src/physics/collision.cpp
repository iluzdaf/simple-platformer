...
namespace simple_platformer
{
    namespace
    {
        ...
        bool columnBlocksMovement(const TileMap& map, int column, int firstRow, int lastRow)
        {
        ...
        bool rowBlocksMovement(const TileMap& map, int row, int firstColumn, int lastColumn)
        {
            ...
            CollisionContacts& contacts)
        {
            ...
            for (int column = firstColumn;
                 movingRight ? column <= lastColumn : column >= lastColumn;
                 column += step)
            {
